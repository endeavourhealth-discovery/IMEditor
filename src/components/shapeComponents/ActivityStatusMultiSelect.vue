<template>
  <div class="activity-status-container">
    <span class="p-float-label">
      <Dropdown class="activity-status-dropdown" :id="id" :class="invalid && 'invalid'" v-model="activityStatus" :options="statusOptions" optionLabel="name" />
...
const statusOptions = computed(() =>
  store.state.filterOptions.status.map(item => {
...
let activityStatus = ref(props.dataValue);
watch(activityStatus, newValue => {

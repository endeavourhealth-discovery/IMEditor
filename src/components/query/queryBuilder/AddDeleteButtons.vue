...
import { QueryComponentType } from "im-library/dist/types/enums/Enums";
...
export default defineComponent({
  ...
  props: {
    ...
    options: { type: Array as PropType<Array<QueryComponentType>>, required: true }
  },
  emits: {
    addNextClicked: (_payload: QueryComponentType) => true,
    deleteClicked: () => true
  },
  watch: {
    selected: {
  ...
  data() {
    return {
      menuOptions: [] as any[],
      selected: null as QueryComponentType | null
    };
  },
  methods: {
